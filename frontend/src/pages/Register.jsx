    ...
    <div className="min-h-screen bg-dark-bg flex flex-col items-center justify-center p-6 font-sans relative overflow-hidden">
      ...
      <div className="w-full max-w-md glass-card rounded-3xl p-8 md:p-10 relative z-10 animate-slide-up">
        <div className="mb-8">
          ...
          <p className="text-slate-400">Let's get you started sharing your links!</p>
        </div>
        ...
        <p className="mt-8 text-center text-slate-400">
          Already have an account? <Link to="/login" className="text-primary-400 hover:text-primary-300 font-semibold transition-colors">Login</Link>
        </p>
      </div>
    </div>
  );
